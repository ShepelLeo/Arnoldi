...
fn accumulate_givens(
    ...
    // Быстрая ленточная версия.
    // Если нужна полная матрица Q для проверки H_out = Q^* H Q,
    // замените эту строку на:
    //
    // let row_count = rotation.nrows();
    //
